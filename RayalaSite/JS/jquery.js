...
; (function ($) {
    ...
    $.fn.bPopup = function (options, callback) {
        ...
        function init() {
            ...
            popups = ($w.data('bPopup') || 0) + 1, id = prefix + popups + '__', fixedVPos = o.position[1] !== 'auto', fixedHPos = o.position[0] !== 'auto', fixedPosStyle = o.positionStyle === 'relative', height = $popup.outerHeight(true), width = $popup.outerWidth(true);
